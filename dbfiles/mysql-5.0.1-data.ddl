...
--  Ran at: 9/26/22 5:01 PM
--  Against: null@offline:mysql?changeLogFile=/Users/dragusa/temp/other_domibus/domibus/Domibus-MSH-db/target/liquibase/changelog-5.0.1-data.mysql
...
INSERT INTO TB_VERSION (VERSION, BUILD_TIME, CREATION_TIME) VALUES ('5.0.1', '2022-09-26 14:00', (UTC_TIMESTAMP))
            ON DUPLICATE KEY UPDATE BUILD_TIME='2022-09-26 14:00', CREATION_TIME = (UTC_TIMESTAMP);
